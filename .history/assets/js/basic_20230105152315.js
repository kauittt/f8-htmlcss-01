...
//! MODAL
const logIn = document.querySelector(".header-nav-account__btn");
const signIn = document.querySelector(".header-nav-account__link");
const modal = document.querySelector(".modal");
logIn.addEventListener("click", function (e) {
    modal.classList.add("modal--show");
    logIn.classList.add("modal-logIn--show");
});
